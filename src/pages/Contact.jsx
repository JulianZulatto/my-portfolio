...
function Contact() {
    return (
        <section id='contact' className="container mt-5">
            <h2 className="mb-4" style={{ color: "#55e6a5" }}>Contacto</h2>
            <ul className="list-unstyled">
                <li className="mb-3 d-flex align-items-center">
                    <i className="bi bi-envelope-fill me-2 fs-4 text-primary"></i>
                    <span className="me-2 fw-bold" style={{ color: "#55e6a5" }}>Email:</span>
                ...
                <li className="mb-3 d-flex align-items-center">
                    ...
                    <span className="me-2 fw-bold" style={{ color: "#55e6a5" }}>LinkedIn:</span>
                ...
                <li className="mb-3 d-flex align-items-center">
                    ...
                    <span className="me-2 fw-bold" style={{ color: "#55e6a5" }}>GitHub:</span>
                ...
                <li className="mb-3 d-flex align-items-center">
                    ...
                    <span className="me-2 fw-bold" style={{ color: "#55e6a5" }}>WhatsApp:</span>
